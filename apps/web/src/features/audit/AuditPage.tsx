...
export function AuditPage() {
  ...
  async function load(cursor?: string, signal?: AbortSignal) {
    try {
      ...
      setPage(await api<AuditPageData>(`/api/v1/audit${suffix}`, { signal }));
    } catch (err) {
